...
namespace StarryEyes.Breezy.Api.Rest
{
    public static class Relations
    {
        ...
        {
            string endpoint = ApiEndpoint.EndpointApiV1a.JoinUrl("/followers/ids.json");
        ...
        public static IObservable<long> GetFriendsIdsAll(this AuthenticateInfo info,
            long? userId = null, string screenName = null)
        {
            string endpoint = ApiEndpoint.EndpointApiV1a.JoinUrl("/friends/ids.json");
            return info.GetIdsAllSink(endpoint, userId, screenName);
        }

        public static IObservable<long> GetIncomingFriendshipsAll(this AuthenticateInfo info)
        {
            string endpoint = ApiEndpoint.EndpointApiV1a.JoinUrl("/friendships/incoming.json");
            return info.GetIdsAllSink(endpoint);
        }

        public static IObservable<long> GetOutgoingFriendshipsAll(this AuthenticateInfo info)
        {
            string endpoint = ApiEndpoint.EndpointApiV1a.JoinUrl("/friendships/outgoing.json");
            return info.GetIdsAllSink(endpoint);
        }
            ...
            long? target_id = null, string target_screen_name = null)
        {
            ...
            return info.GetOAuthClient()
                .SetEndpoint(ApiEndpoint.EndpointApiV1a.JoinUrl("/friendships/show.json"))
                .SetParameters(param)
                .GetResponse()
            ...
            long? user_id = null, string screen_name = null, bool enableNotification = false)
        {
            ...
            return info.GetOAuthClient()
                .SetEndpoint(ApiEndpoint.EndpointApiV1a.JoinUrl("/friendships/create.json"))
            ...
            long? user_id = null, string screen_name = null)
        {
            ...
            return info.GetOAuthClient()
                .SetEndpoint(ApiEndpoint.EndpointApiV1a.JoinUrl("/friendships/destroy.json"))
                .SetMethodType(Codeplex.OAuth.MethodType.Post)
                .SetParameters(param)
                .GetResponse()
                .ReadUser();
            ...
            IEnumerable<long> userIds, IEnumerable<string> screenNames)
        {
            ...
            return info.GetOAuthClient()
                .SetEndpoint(ApiEndpoint.EndpointApiV1a.JoinUrl("/friendships/lookup.json"))
                .SetParameters(param)
                .GetResponse()
                .UpdateRateLimitInfo(info)
                .ReadString()
        ...
        {
            string endpoint = ApiEndpoint.EndpointApiV1a.JoinUrl("/blocks/ids.json");
            return info.GetIdsAllSink(endpoint);
        }
            ...
            long? user_id = null, string screen_name = null, bool include_entities = true, bool? skip_status = null)
        {
            ...
            return info.GetOAuthClient()
                .SetEndpoint(ApiEndpoint.EndpointApiV1a.JoinUrl("/blocks/create.json"))
                .SetParameters(param)
                .SetMethodType(Codeplex.OAuth.MethodType.Post)
                .GetResponse()
                .ReadUser();
            ...
            long? user_id = null, string screen_name = null, bool include_entities = true, bool? skip_status = null)
        {
            ...
            return info.GetOAuthClient()
                .SetEndpoint(ApiEndpoint.EndpointApiV1a.JoinUrl("/blocks/destroy.json"))
                .SetParameters(param)
                .SetMethodType(Codeplex.OAuth.MethodType.Post)
                .GetResponse()
                .ReadUser();
