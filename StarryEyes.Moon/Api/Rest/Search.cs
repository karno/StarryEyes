...
namespace StarryEyes.Moon.Api.Rest
{
    public static class Search
    {
        ...
        {
            return info.GetOAuthClient()
                .SetEndpoint(ApiEndpoint.EndpointApiV1.JoinUrl("/saved_searches.json"))
                .GetResponse()
                .UpdateRateLimitInfo(info)
                .ReadString()
        ...
        public static IObservable<SavedSearchJson> CreateSavedSearch(this AuthenticateInfo info, string query)
        {
            ...
            return info.GetOAuthClient()
                .SetEndpoint(ApiEndpoint.EndpointApiV1.JoinUrl("/saved_searches/create.json"))
                .SetParameters(param)
        ...
        {
            return info.GetOAuthClient()
                .SetEndpoint(ApiEndpoint.EndpointApiV1.JoinUrl("/saved_searches/destroy/" + id + ".json"))
                .SetMethodType(Codeplex.OAuth.MethodType.Post)
                .GetResponse()
                .ReadString()
                .DeserializeJson<SavedSearchJson>();
