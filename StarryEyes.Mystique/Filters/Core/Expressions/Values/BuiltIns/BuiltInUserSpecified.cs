...
{
    public sealed class BuiltInUserSpecified : BuiltInUserRepresentationBase
    {
        long _userId;
        AccountData _adata;

        public BuiltInUserSpecified(string screenName)
        {
        ...
        public BuiltInUserSpecified(long id)
        {
            _userId = id;
            GetAccountData();
        }
