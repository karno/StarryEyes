    ...
    public static class Lists
    {
            ...
            long? user_id = null, string screen_name = null)
        {
            ...
            return info.GetOAuthClient()
                .SetEndpoint(ApiEndpoint.EndpointApiV1.JoinUrl("/lists/all.json"))
                .SetParameters(param)
                .GetResponse()
            ...
            long? owner_id = null, string owner_screen_name = null)
        {
            ...
            return info.GetOAuthClient()
                .SetEndpoint(ApiEndpoint.EndpointApiV1.JoinUrl("lists/show.json"))
                .SetParameters(param)
                .GetResponse()
                .UpdateRateLimitInfo(info)
                .ReadList();
            ...
            string name, bool isPrivate = false, string description = null)
        {
            ...
            return info.GetOAuthClient()
                .SetEndpoint(ApiEndpoint.EndpointApiV1.JoinUrl("/lists/members/create.json"))
                .SetParameters(param)
            ...
            string name = null, bool? isPrivate = null, string description = null)
        {
            ...
            return info.GetOAuthClient()
                .SetEndpoint(ApiEndpoint.EndpointApiV1.JoinUrl("/lists/update.json"))
                .SetParameters(param)
                .SetMethodType(Codeplex.OAuth.MethodType.Post)
                .GetResponse()
                .ReadList();
            ...
            long list_id, string slug, long? owner_id = null, string owner_screen_name = null)
        {
            ...
            return info.GetOAuthClient()
                .SetEndpoint(ApiEndpoint.EndpointApiV1.JoinUrl("/lists/destroy.json"))
                .SetParameters(param)
                .SetMethodType(Codeplex.OAuth.MethodType.Post)
                .GetResponse()
                .ReadList();
            ...
            bool? include_entities = true, bool? include_rts = false)
        {
            ...
            return info.GetOAuthClient()
                .SetEndpoint(ApiEndpoint.EndpointApiV1.JoinUrl("/lists/statuses.json"))
                .SetParameters(param)
                .GetResponse()
                .UpdateRateLimitInfo(info)
                .ReadTimeline();
            ...
            string endpoint, Dictionary<string, object> param, long cursor = -1)
        {
            ...
            long next_cursor = 0;
            return info.GetOAuthClient()
                .SetEndpoint(ApiEndpoint.EndpointApiV1.JoinUrl(endpoint))
                .SetParameters(p)
                .GetResponse()
                .UpdateRateLimitInfo(info)
                .ReadString()
            ...
            IEnumerable<long> user_id = null, IEnumerable<string> screen_name = null)
        {
            ...
            return info.GetOAuthClient()
                .SetEndpoint(ApiEndpoint.EndpointApiV1.JoinUrl("/lists/members/create_all.json"))
                .SetMethodType(Codeplex.OAuth.MethodType.Post)
                .SetParameters(param)
                .GetResponse()
                .ReadUsers();
            ...
            long? user_id = null, string screen_name = null)
        {
            ...
            return info.GetOAuthClient()
                .SetEndpoint(ApiEndpoint.EndpointApiV1.JoinUrl("/lists/members/destroy.json"))
                .SetMethodType(Codeplex.OAuth.MethodType.Post)
                .SetParameters(param)
                .GetResponse()
                .ReadUser();
            ...
            IEnumerable<long> user_id = null, IEnumerable<string> screen_name = null)
        {
            ...
            return info.GetOAuthClient()
                .SetEndpoint(ApiEndpoint.EndpointApiV1.JoinUrl("/lists/members/destroy_all.json"))
                .SetMethodType(Codeplex.OAuth.MethodType.Post)
                .SetParameters(param)
                .GetResponse()
                .ReadUsers();
            ...
            long? list_id = null, string slug = null, long? owner_id = null, string owner_screen_name = null)
        {
            ...
            return info.GetOAuthClient()
                .SetEndpoint(ApiEndpoint.EndpointApiV1.JoinUrl("/lists/subscribers/create.json"))
                .SetParameters(param)
            ...
            long? list_id = null, string slug = null, long? owner_id = null, string owner_screen_name = null)
        {
            ...
            return info.GetOAuthClient()
                .SetEndpoint(ApiEndpoint.EndpointApiV1.JoinUrl("/lists/subscribers/destroy.json"))
                .SetParameters(param)
                .SetMethodType(MethodType.Post)
                .GetResponse()
                .ReadList();
