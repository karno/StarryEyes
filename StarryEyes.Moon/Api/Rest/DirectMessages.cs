    ...
    public static class DirectMessages
    {
            ...
            bool include_entities = true, bool? skip_status = null)
        {
            ...
            return info.GetOAuthClient()
                .SetEndpoint(ApiEndpoint.EndpointApiV1.JoinUrl("/direct_messages.json"))
                .SetParameters(param)
                .GetResponse()
            ...
            bool include_entities = true)
        {
            ...
            return info.GetOAuthClient()
                .SetEndpoint(ApiEndpoint.EndpointApiV1.JoinUrl("/direct_messages/sent.json"))
                .SetParameters(param)
                .GetResponse()
                .UpdateRateLimitInfo(info)
                .ReadDirectMessages();
            ...
            long id, bool include_entities = true)
        {
            ...
            return info.GetOAuthClient()
                .SetEndpoint(ApiEndpoint.EndpointApiV1.JoinUrl("/direct_messages/destroy/" + id + ".json"))
            ...
            string text, long? user_id = null, string screen_name = null)
        {
            ...
            return info.GetOAuthClient()
                .SetEndpoint(ApiEndpoint.EndpointApiV1.JoinUrl("/direct_messages/new.json"))
                .SetMethodType(Codeplex.OAuth.MethodType.Post)
                .SetParameters(param)
                .GetResponse()
                .ReadDirectMessage();
        ...
        {
            return info.GetOAuthClient()
                .SetEndpoint(ApiEndpoint.EndpointApiV1.JoinUrl("/direct_messages/show/" + id + ".json"))
